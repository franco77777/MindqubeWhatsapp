...
public class Send {
        ...
        public byte[] imageUrlToWhatsapp(OkWhatsappImageDto imageResponse) throws IOException {
                ...
                try {
                        HttpRequest request = HttpRequest.newBuilder()
                                        ...
                                        // \"whatsapp\", \"recipient_type\": \"individual\", \"to\": \""+number+"\",
        ...
        public OkWhatsappResponseDto ImageToClient(UserEntity user, WhatsappMessageEntity uploadImage)
                        throws IOException {
                OkHttpClient client = new OkHttpClient().newBuilder()
                                .build();
                MediaType mediaType = MediaType.parse("application/json");
